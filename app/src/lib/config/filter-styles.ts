...
export const dropdownPanelClass =
	'absolute left-0 z-20 mt-1.5 max-h-48 min-w-[12rem] origin-top-left animate-dropdown-in overflow-y-auto rounded-md border border-surface-border bg-surface py-1 shadow-lg shadow-black/15 ring-1 ring-white/[0.07]';
